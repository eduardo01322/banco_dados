 ...
 * <quando> = determina se dispara antes (before) ou depois (after) se concluida
 * <acao> = É representada pelos comandos insert, update e delete
 */
...
begin
	insert into log (data_hora, tabela, atividade, id, aux)
	values (current_timestamp(),'Cliente', 'insert', old.cliente_id,
